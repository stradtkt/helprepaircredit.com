<section class="testimonial-container-1">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 mt-5 text-center">
                <h3>These are the testimonials from the people that CCRS has helped</h3>
                <p>We thank you for the reviews and encourage people to leave one</p>
            </div>
        </div>
        <div class="row mt-5 mb-5">
        <div class="col-sm-3 col-md-3 col-lg-3 mt-5 mb-5 text-center">
            <div class="card">
...
<section class="testimonial-container-2"></section>
<section class="testimonial-container-3"></section>