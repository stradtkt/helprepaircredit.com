 ...
 <div class="u-gradient-half-primary-v3">
  <div class="container position-relative u-space-3-top z-index-2">
      ...
      <div class="position-abs">
            ...
            <p>
                    At our blog 
                <strong class="u-text-animation u-text-animation--typing blog"></strong>
            </p>
            </div>
            </div>
            <img class="blog-hero" src="assets/theme/assets/svg/flat-icons/business-analysis-flat-concept-illustration.svg" alt="SVG Illustration">
      </div>
    </div>
  </div>
</div>
